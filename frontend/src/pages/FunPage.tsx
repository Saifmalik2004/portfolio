...
import { Terminal, MessageCircle, X, Gamepad2, Code, Sparkles } from 'lucide-react';
import TerminalInterface from '../components/fun/TerminalInterface';
import ChatbotInterface from '../components/fun/ChatbotInterface';

type ActiveFeature = 'terminal' | 'chatbot' | null;
...
const FunPage = () => {
  ...
  const features = [
    ...
    },
    {
      id: 'chatbot' as const,
      title: 'AI Assistant',
      description: 'Chat with AI about my skills and experience',
      icon: MessageCircle,
      ...
      >
        ...
        <div className="pt-20 h-full">
          {activeFeature === 'terminal' ? (
            <TerminalInterface onExit={handleExit} />
          ) : (
            <ChatbotInterface onExit={handleExit} />
          )}
        </div>
      </motion.div>
    );
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
            ...
            <div className="text-center">
              ...
              <div className="grid md:grid-cols-2 gap-6 text-left">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">AI Chat Experience</h4>
                    <p className="text-gray-600 text-sm">
                      Click to chat with an AI assistant about my skills, projects, and experience. Ask anything you want to know!
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            {[
              { label: 'Interactive Features', value: '2+', icon: '🎮' },
